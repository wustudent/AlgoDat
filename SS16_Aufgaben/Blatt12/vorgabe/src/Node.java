...
public class Node implements Comparable<Node> {
	...
	/**
	 * Returns a heuristically determined distance between two nodes
	 * @param n
	 * 			node to estimate distance to
	 * @param name
	 * 			name of the estimation heuristic
	 * @return
	 */	
	public double estimateDistance(Node n, String name) {
		return Double.POSITIVE_INFINITY; //this class does not have a sensible heuristic
	}
