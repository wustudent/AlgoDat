...
public class Picture {
    ...
    */
     ...
     * @param picUrl path of *.bmp or .png picture
     */
    public Picture(String picUrl)  throws IOException {      
    ...
    **/
     ...
     * @return none
     */
    private void openAndSetPicture(String picUrl) throws IOException {
         ...
         //complain loudly if buffer is empty:
         if (this.width == 0 && this.height == 0) {throw new IOException("Could not read from file " + picUrl);}
