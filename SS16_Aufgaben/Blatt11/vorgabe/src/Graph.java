...
public interface Graph {
	 ...
	 *        targetNode
	 *        	  stop when the target node is found. If index does not exist, run exhaustively     
	 */
	public void populateDijkstraFrom(int startNodeIndex, int targetNodeIndex);
	 ...
	 *        targetNode
	 *        	  stop when the targetNode is found. If null, run exhaustively     
	 */
